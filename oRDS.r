...
#' @export
#' @import igraph
#' @importFrom dplyr any_vars arrange bind_rows desc distinct filter filter_at group_by mutate n_distinct progress_estimated select select_at semi_join slice summarise transmute ungroup vars count
...
#' @importFrom GenomicRanges GRanges mcols as.data.frame
