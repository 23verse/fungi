...
#' @export
#' @include xClassifyPerf.r
#' @examples
#' \dontrun{
#' pPerf <- xClassifyPerf(prediction, GSP, GSN)
#' }

xClassifyPerf <- function(prediction, GSP, GSN, rescale=FALSE, plot=c("none","ROC","PR"), highlight=FALSE, trim=TRUE, verbose=TRUE)
{
