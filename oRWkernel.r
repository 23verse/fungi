...
#'
#' \code{oRWkernel} is supposed to calculate a weighted random walk kernel (at a predefined number of steps) for estimating pairwise affinity between nodes.
#'
...
oRWkernel <- function(g, steps=4, chance=2, verbose=TRUE)
{
